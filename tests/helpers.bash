#!/usr/bin/env bash
# tests/helpers.bash — shared test helpers for APIVR-Delta ECL bats suite
...
setup_envelope_fixture() {
  local kind="$1"
  local from_eidolon="${2:-apivr}"
  local eidolon_version="${3:-3.7.1}"
  ...
  \"to\":   { \"eidolon\": \"apivr\",            \"version\": \"3.7.1\" },
