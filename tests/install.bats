#!/usr/bin/env bats
# tests/install.bats — ECL install gates for APIVR-Delta v3.7.1
...
@test "install.sh declares EIDOLON_VERSION 3.7.1" {
  grep -q 'EIDOLON_VERSION="3.7.1"' "${REPO_ROOT}/install.sh"
}
